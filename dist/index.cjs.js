...
var PriceLink$1 = styled__default['default'].a(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var CakePrice = function (_a) {
    var cakePriceUsd = _a.cakePriceUsd, isDark = _a.isDark;
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink$1, { href: "https://poocoin.app/tokens/0x6a8d8f3c224cd16d7b143930fb428faf20e9802b", target: "_blank" },
...
var ThemeSwitcher = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); } },
        React__default['default'].createElement(Flex, { alignItems: "center" },
            React__default['default'].createElement(SunIcon, { color: isDark ? "textDisabled" : "#F04D92", width: "24px" }),
            React__default['default'].createElement(Text, { color: "#d086a5", mx: "4px" }, "/"),
            React__default['default'].createElement(MoonIcon, { color: isDark ? "#F04D92" : "#d086a5", width: "24px" }))));
};
...
var YPantyPrice$1 = React__default['default'].memo(YPantyPrice);
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null,
            ...
            React__default['default'].createElement(YPantyPrice$1, { yPantyPriceUsd: ypantyPriceUsd, isDark: isDark })),
